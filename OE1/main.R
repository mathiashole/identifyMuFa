...
transform_data <- function(data) {
  ...
  # data$sp_high_filtred_name_gff <- paste0("high_equal_", data$keyword_sum, "_", data$no_gff_basename, ".gff")
  # data$sp_low_filtred_name_gff <- paste0("low_", data$keyword_sum, "_", data$no_gff_basename, ".gff")
