...
<div id="representation-options">
  <label><input type="checkbox" value="cartoon" checked> Cartoon</label>
  <label><input type="checkbox" value="surface"> Surface</label>
  <label><input type="checkbox" value="ball+stick"> Ball+Stick</label>
  <label><input type="checkbox" value="spacefill"> Spacefill</label>
  <label><input type="checkbox" value="licorice"> Licorice</label>
  <label><input type="checkbox" value="trace"> Trace</label>
  <label><input type="checkbox" value="tube"> Tube</label>
  <label><input type="checkbox" value="backbone"> Backbone</label>
</div>
...
function actualizarRepresentacion() {
  ...
  const selectedRepresentations = getSelectedRepresentations();
  selectedRepresentations.forEach(rep => {
    currentComponent.addRepresentation(rep, { colorScheme: color });
  });
...
function getSelectedRepresentations() {
  const checkboxes = document.querySelectorAll('#representation-options input[type="checkbox"]:checked');
  ...
  document.querySelectorAll('#representation-options input[type="checkbox"]').forEach(cb => {
    cb.addEventListener('change', actualizarRepresentacion);
  });
