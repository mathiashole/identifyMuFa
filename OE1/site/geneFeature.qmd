...
mode <- "gff"
# input_arg <- "home/mathias/study/maestria/scoville_data/execution_args_9900.tsv"
...
# genomes <- calculate_fasta_feature(file.path("../../../study/maestria/genomic_data", transformed$fasta_basename), "genome")
...
# Llamamos a la funcion para obtener GC y largo de cada contig, de cada genoma
# all_code_prot <- calculate_fasta_feature(file.path(output_dir ,transformed$out_rest_gscissors), "gene")
...
target_protein <- calculate_fasta_feature(file.path(output_dir, transformed$out_gscissors_all), "gene")
