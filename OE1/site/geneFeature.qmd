...
🔍 Análisis realizados
    ...
    Mapeo de genes DGF-1 en los distintos cromosomas

    Análisis comparativo entre cepas y genotipos

    Evaluación de la proximidad a regiones funcionales del genoma, como orígenes de replicación (OriCs)

📊 Análisis realizados

*  Longitud y contenido de GC de las secuencias

*  Identificación de pseudogenes

*  Visualización de la distribución cromosómica

*  Asociación con regiones funcionales del genoma (e.g. orígenes de replicación)

*  Comparación entre genotipos y ensamblados disponibles

🧬 Genomas utilizados
Los genomas fueron obtenidos de [**tritrydb**](https://tritrypdb.org/tritrypdb/app) y [**NCBI**](https://www.ncbi.nlm.nih.gov/), e incluyen:
