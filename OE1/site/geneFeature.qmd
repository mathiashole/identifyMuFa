...
Para ello se desarrollaron funciones en R que permiten automatizar y reutilizar el código en diferentes etapas del análisis. Las visualizaciones se generaron utilizando los siguientes paquetes:
...
Estas representaciones permiten comparar fácilmente la variabilidad entre genomas y detectar posibles patrones de conservación o desviación en las características estructurales de los genes.
