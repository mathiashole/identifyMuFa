...
dinucleotide_table <- nucleotide_frequncy(file.path(output_dir, transformed$out_gscissors_all), type_frequency = "dinucleotide")
# dinucleotide_table <- nucleotide_frequncy(file.path("output_directory", transformed$out_gscissors_all), type_frequency = "dinucleotide")
...
trinucleotide_table <- nucleotide_frequncy(file.path(output_dir, transformed$out_gscissors_all), type_frequency = "trinucleotide")
#trinucleotide_table <- nucleotide_frequncy(file.path("output_directory", transformed$out_gscissors_all), type_frequency = "trinucleotide")
...
# Leer en formato TSV
dinucleotide_all_protein_coding <- read.table("../output_directory/dinucleotide_frequency_all_protein_coding.tsv", 
                                              sep = "\t", header = TRUE, stringsAsFactors = FALSE)

trinucleotide_all_protein_coding <- read.table("../output_directory/trinucleotide_frequency_all_protein_coding.tsv", 
                                               sep = "\t", header = TRUE, stringsAsFactors = FALSE)
