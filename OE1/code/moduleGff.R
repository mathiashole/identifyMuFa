...
transform_data <- function(data) {
  ...
  data$blastp_origin_result <- paste0("blastp_out_high_", data$keyword_sum, "_", data$no_gff_basename, "_translated.txt")
  data$brefiner_origin_blastp <- paste0("bRefiner_blastp_out_high_", data$keyword_sum, "_", data$no_gff_basename, "_translated.txt")
