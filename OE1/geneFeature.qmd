...
A partir de estos genomas, se extrajeron secuencias de los genes ``r key_name``, con el objetivo de realizar análisis de contenido de `GC`, `longitud de las secuencias`, y otros aspectos relevantes para la caracterización de estas secuencias.
...
knitr::kable(base_prot, col.names = c("Archivos FASTA"))
