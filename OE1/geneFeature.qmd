...
# output_dir <- "/home/usuario/Data_Rstudio/chop_genome"  # Cambia esto a la ruta de tu directorio
output_dir <- "output_directory/"
# leer tabla de datos ()
#data_init <- read.delim("/home/usuario/Proyectos/maestria/datos_ejecucion_genomas2.tsv.csv", sep = "\t", header = FALSE)
## NEED OUTPUT DIR
data_transformed <- read.delim("output_directory/execution_args_9900.tsv", sep = "\t", header = FALSE)
########################################
