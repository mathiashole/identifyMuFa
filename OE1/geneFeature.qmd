...
A partir de estos genomas, se extrajeron secuencias de interés, con el fin de realizar análisis de contenido de `GC`, `longitud de las secuencias`, y otros aspectos relevantes para la caracterización de estas secuencias.
