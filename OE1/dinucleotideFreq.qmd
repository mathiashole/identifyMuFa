...
dinucleotide_all_protein_coding_csv <- read.csv("output_directory/dinuclotide_frequency_all_protein_coding.csv", header = TRUE, sep = ",", fill = TRUE, quote = "")
...
# Quick execution transformed_df <- transform_columns(df, c("col1", "col2"))
dinucleotide_table <- transform_columns(dinucleotide_table, "ID")
dinucleotide_all_protein_coding <- transform_columns(dinucleotide_all_protein_coding, "ID")
