...
# path_di_protein_code_safe_tsv <- file.path("output_directory/", paste0("genome_gc_length.tsv"))
# path_di_protein_code_safe <- file.path("output_directory/", paste0("genome_gc_length.csv"))
...
# path_tri_protein_code_safe_tsv <- file.path("output_directory/", paste0("genome_gc_length.tsv"))
# path_tri_protein_code_safe <- file.path("output_directory/", paste0("genome_gc_length.csv"))
# write.csv(genomes, file = path_genome_safe, row.names = FALSE, col.names = TRUE, quote = FALSE)
# write.table(genomes, file = path_genome_safe_tsv, row.names = FALSE, col.names = TRUE, sep = "\t", quote = FALSE)
