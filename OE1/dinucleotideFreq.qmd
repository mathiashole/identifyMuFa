...
# Convert dinucleotide columns to numeric
cols_to_convert <- c("aa", "tt", "ac", "gt", "ag", "ct", "ca", "tg", "cc", "gg", "ga", "tc", "at", "cg", "gc", "ta")
dinucleotide_al_protein_coding[cols_to_convert] <- lapply(dinucleotide_all_protein_coding[cols_to_convert], as.numeric)

# Now apply the operations to combine frequencies
combained_dinucleotide <- data.frame(
  "Genome" = dinucleotide_all_protein_coding[,"file"],
  "id" = dinucleotide_all_protein_coding[,"ID"],
  "aa.tt" = dinucleotide_al_protein_coding[,"aa"] + dinucleotide_all_protein_coding[,"tt"],
  "ac.gt" = dinucleotide_al_protein_coding[,"ac"] + dinucleotide_all_protein_coding[,"gt"],
  "ag.ct" = dinucleotide_al_protein_coding[,"ag"] + dinucleotide_all_protein_coding[,"ct"],
  "ca.tg" = dinucleotide_al_protein_coding[,"ca"] + dinucleotide_all_protein_coding[,"tg"],
  "cc.gg" = dinucleotide_al_protein_coding[,"cc"] + dinucleotide_all_protein_coding[,"gg"],
  "ga.tc" = dinucleotide_al_protein_coding[,"ga"] + dinucleotide_all_protein_coding[,"tc"],
