...
calculate_nucleotide_frequencies <- function(fasta_files, type_frequency = "dinucleotide", type) {
  # fasta_files <- list.files(path = directory, pattern = "^out_.*\\.fasta$", full.names = TRUE)
...
dinucleotide_table <- calculate_nucleotide_frequencies(fasta_files, type_frequency = "dinucleotide", "gene")
