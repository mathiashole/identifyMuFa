...
nucleotide_frequncy <- function(fasta_files, type_frequency = "dinucleotide", type_seq = "gene") {
...
dinucleotide_table <- nucleotide_frequncy(fasta_files, type_frequency = "trinucleotide", type_seq = "gene")
