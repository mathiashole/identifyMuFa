...
reactable(dinucleotide_table[,c(3:16)], highlight = TRUE)

```

```{r}

dinucleotide_data <- dinucleotide_table[, -c(1, 2)]  # Exclude the first columns (File and ID)
...
autoplot(como, data = dinucleotide_table, colour = 'File', loadings = TRUE, loadings.label = TRUE, loadings.colour = 'grey64')
