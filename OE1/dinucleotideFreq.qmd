...
tsne_perform_dinucloetide_genome <- list()
...
for (genome in genomes) {
  ...
  tsne_perform_dinucloetide_genomes <- perform_tsne_highlight(combained_dinucleotide, highlight_ids = highlight_ids, file_col = "Genome", id_col = "id") # genome_data, dinucleotide_table$ID, pca_result$pca_result, col_palette = palette_to_genome

  tsne_perform_dinucloetide_genome[[genome]] <- tsne_perform_dinucloetide_genome
}
