...
dinuclotide_all_protein_coding <- read.table("output_directory/g", sep = "\t", header = TRUE)
trinuclotide_all_protein_coding <- read.table("output_directory/g", sep = "\t", header = TRUE)
