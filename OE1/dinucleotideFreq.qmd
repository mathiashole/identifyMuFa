...
perform_tsne <- function(data, highlight_ids, file_col = "File", id_col = "ID", perplexity = 30, max_iter = 1000, col_palette = NULL) {
  # Exclude 'File' and 'ID' columns from numerical analysis
  ...
  combained_dinucleotide_clean <- combained_dinucleotide[!duplicates, ] # NEED CHECK WITH BOSS
